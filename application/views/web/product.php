...
<div class="no-gutter pt-4 mt-5 bg-light">
    ...
    <div class="no-gutter text-center">
        <div class="card shadow rounded border-0 mx-3 mb-3 text-dark">
            <div class="card-body">
                <h5 class="mt-2 mb-1">Kresek Jumbo Rukun&trade;</h5>
                <h1 class="mb-1">Kuat dan Elastis</h1>
                <h5 class="mb-3">Kuat untuk angkat air galon.</h5>
                <p class="mb-2">
                    <a class="" href=" <?= base_url() ?>products/jumbobag">Pelajari &rarr;</a>
                </p>
    ...
    <div class="no-gutter text-center">
        <div class="card shadow rounded border-0 mx-3 mb-3 bg-white text-dark">
            <div class="card-body">
                <h5 class="text-center mt-2 mb-1">Kantong Belanja</h5>
                <h1 class="text-center mb-1">Warna-warni. Menakjubkan.</h1>
                <h5 class="text-center mb-3">Tersedia dalam 6 warna.</h5>
                <p class="mb-2">
                    <a class="" href=" <?= base_url() ?>products/shoppingbag">Pelajari &rarr;</a>
                </p>
    ...
    <!-- Third Tier Items -->
    <div class="row text-center mx-1 mb-3">
        <div class="col-lg-6 mb-3">
            <div class="card shadow border-0 bg-gradient-white text-dark">
                <div class="card-body">
                    <h5 class="text-center text-primary mt-2 mb-1">Kantong Plastik Rukun&trade;</h5>
                    <h3 class="text-center mb-1">Banyak ukuran dan warna.</h3>
                    <a class="text-primary mb-2" href=" <?= base_url() ?>products/plasticbag">Pelajari &rarr;</a>
                </div>
        ...
        <div class="col-lg-6">
            <div class="card shadow border-0 bg-gradient-white text-dark">
                <div class="card-body">
                    <h5 class="text-center text-primary mt-2 mb-1">Kantong Kemasan</h5>
                    <h3 class="text-center mb-1">Lindungi yang baik di dalam.</h3>
                    <a class="text-primary" href=" <?= base_url() ?>products/inner">Pelajari &rarr;</a>
                </div>
                <div class="text-center mb-3">
