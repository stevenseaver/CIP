...
<div class="container-fluid pt-4 mt-5">
    ...
    <div id="english">
        ...
        <p class="text-dark mx-2 px-2 text-justify">
            c. User/Customer is party who use/s Our services, both individuals and/or legal entities, which include buyers registered or not registered on our Website that contacted us.
        </p>
        <p class="text-dark mx-2 px-2 text-justify">
            d. Buyer is You who doesn't have to be registered on Our Website and make a purchase of goods sold by Us either on our Website or other marketing platform.
        </p>
        <p class="text-dark mx-2 px-2 text-justify">
        ...
        <p class="text-dark mx-2 px-2 text-justify">
            l. Rukun&trade; and Jemblung&trade; are trade marks of UD. Cakra Inti Plastik, trademark register pending. All rights reserved. Violation to such intellectual properties will be dealt with severly.
        </p>
        <h5 class="text-dark mx-2 px-2 text-justify font-weight-bold">
            2. Our Limitation and Liabilities
        </h5>
        <p class="text-dark mx-2 px-2 text-justify">
            a. We provide the Website and/or Application as is and do not declare or guarantee that the reliability, timeliness, quality, performance, availability, accuracy, or security of our Service that uses third party support/APIs can meet your needs and will meet your expectations, including but not limited to Third Party Services, Third Party Content, Offers and Payment Methods which are entirely the responsibility of the Service Provider, including the Third Party Content Provider, the Offer Providers or the Seller, and the Payment Method Provider.
        </p>
        <p class="text-dark mx-2 px-2 text-justify">
    ...
    <div id="indonesia" style="display:none" lang="id">
        ...
        <div class="d-flex mb-3 mx-2 px-2 text-justify">
            <small>Terakhir diperbaharui pada 16 October 2021</small>
        </div>
