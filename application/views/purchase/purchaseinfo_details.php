...
<div class="container-fluid">
    ...
    <a href="<?= base_url('purchasing/purchaseinfo/index?' . http_build_query(['start_date' => $periode['start_date'], 'end_date'   => $periode['end_date'], 'name' => $periode['id'],])) ?>" class="btn btn-white btn-icon-split mb-3">
