...
<div class="container-fluid pt-5 mt-5">
    ...
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-center mt-3 mb-3">
        <h1 class="h3 mb-3 text-primary font-weight-bold"><?= $title ?></h1>
    </div>
                ...
                <div class="card-body">
                    <div class="row py-2 justify-content-center">
                        <div class="col-lg py-1 mx-2 text-center">
                            ...
                            <a href="mailto:info@cakrainti.com" class="text-dark" target="_blank" rel="noopener noreferrer">
                ...
                <div class="card-body">
                    <div class="row py-2 justify-content-center">
                        <div class="col-lg py-1 mx-2 text-center">
                            ...
                            <a href="mailto:cs@cakrainti.com" class="text-dark" target="_blank" rel="noopener noreferrer">
                                <p class="text-primary mb-1">cs@cakrainti.com</p>
                            </a>
                            <a href="https://wa.me/+6281331030398/?text=Hello,%20CS%20inquiries?" target="_blank" rel="noopener noreferer" class="">
        ...
        <div class="col-lg mx-4">
            <div class="card shadow border-0 mb-3">
                <div class="card-body">
                    <div class="row py-2 justify-content-center">
                        <div class="col-lg py-1 mx-2 text-center">
                            <i class="bi bi-person-plus fa-4x mb-3 mx-2 text-dark"></i>
                            <h5 class="text-dark font-weight-bold mb-2">Job Recruitment</h5>
                            <a href="mailto:hr@cakrainti.com" class="text-dark" target="_blank" rel="noopener noreferrer">
        ...
        <div class="col-lg mx-4">
            <div class="card shadow border-0 mb-3">
                <div class="card-body">
                    <div class="row py-2 justify-content-center">
                        <div class="col-lg py-1 mx-2 text-center">
                            <i class="bi bi-piggy-bank fa-4x mb-3 mx-2 text-dark"></i>
                            <h5 class="text-dark font-weight-bold mb-2">Investor Partnership</h5>
                            <a href="mailto:investor@cakrainti.com" class="text-dark" target="_blank" rel="noopener noreferrer">
                ...
                <div class="card-body">
                    <div class="row py-2 justify-content-center">
                        <div class="col-lg py-1 mx-2 text-center">
                            ...
                            <a href="mailto:pr@cakrainti.com" class="text-dark" target="_blank" rel="noopener noreferrer">
                                <p class="text-primary mb-1">pr@cakrainti.com</p>
                            </a>
                ...
                <div class="card-body">
                    <div class="row py-2 justify-content-center">
                        <div class="col-lg py-1 mx-2 text-center">
                            ...
                            <a href="mailto:supplier@cakrainti.com" class="text-dark" target="_blank" rel="noopener noreferrer">
