                    ...
                    <tbody>
                        ...
                        <?php foreach ($customer as $cust) : ?>
                            <tr>
                                ...
                                <td>
                                    <a data-toggle="modal" data-target="#editCustomerModal" class="badge badge-success" data-id="<?= $cust['id'] ?>" data-name="<?= $cust['name'] ?>" data-address="<?= $cust['address'] ?>" data-phone="<?= $cust['phone'] ?>" data-email="<?= $cust['email'] ?>" data-account="<?= $cust['bank_account'] ?>" data-terms="<?= $cust['terms'] ?>">Edit</a>
                                    <a data-toggle="modal" data-target="#deleteCustomerModal" data-id="<?= $cust['id'] ?>" data-name="<?= $cust['name'] ?>" class="badge badge-danger">Delete</a>
                                </td>
                            </tr>
                            <?php $i++; ?>
                        <?php endforeach; ?>
