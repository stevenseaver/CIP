...
<div class="container-fluid pt-4 mt-5">
    ...
    <p class="text-dark mx-5 px-5 text-justify">
        c. User is party who use/s Our services, both individuals and/or legal entities, which include buyers registered on our Website.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        d. Buyer is You who has been registered on Our Website and make a purchase of goods sold by Us on Our Website.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        e. Seller is Us; that acts to sell or offer goods to buyer on Our Website.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        f. Non-electronic agreement is an agreement signed with or without company stamp directly by the parties using ink, in front of public notary or without the presence of a public notary, in accordance with applicable law and regulations.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        g. Device is electronic equipment which is used by any User to use or experience Our services through Our Website and/or Application.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        h. Invoice is a billing document given by Seller to Buyer, in electronic or non-electronic form, which at least contains information on the name, quantity, type, price, total value of goods purchased, and cost to ship goods (if any) as well as payment deadline.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
    ...
    <p class="text-dark mx-5 px-5 text-justify">
        k. Goods are plastic bag or other plastic derrived products owned by Seller which are sold through Our Site.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        l. Rukun&trade; and Jemblung&trade; are trade marks of UD. Cakra Inti Plastik, trademark register pending. Top&reg; are registered trademark of PT. Cahaya Kencana Plastik. All rights reserved. Violation to such intellectual properties will be dealt with severly.
    </p>
    <h5 class="text-dark mx-5 px-5 text-justify font-weight-bold">
        2. Our Limitation and Liabilities
    </h5>
    <p class="text-dark mx-5 px-5 text-justify">
        a. We provide the Website and/or Application as is and do not declare or guarantee that the reliability, timeliness, quality, suitability, availability, accuracy, completeness or security of our Website and/or Application can meet your needs and will meet your expectations, including but not limited to Services, Third Party Content, Offers and Payment Methods which are entirely the responsibility of the Service Provider, the Third Party Content Provider, the Offer Providers or the Seller, and the Payment Method Provider.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
    ...
    <ul class="text-dark mx-5 text-justify">
    ...
    <p class="text-dark mx-5 px-5 text-justify">
        a. Seller was prohibited from manipulating the price of goods for any purpose.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        b. Seller was prohibited from marketing goods that was prohibited by the applicable regulations in the Republic of Indonesia.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        c. Seller is required to provide photos and information of goods completely and clearly according to the real conditions and quality of the goods being sold. If there is any discrepancy between the photos and information of goods uploaded by the Seller and the goods received by the Buyer, then we have the right to cancel and/or withhold payment.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        d. Seller is required to have necessary licenses and certifications as regulated and determined by applicable Law on the goods which will be marketed through Us, licenses and certifications referred to include but are not limited to Copyright, Patents, Trademarks for producers, and Official License for importers.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        e. Based on all licenses and official certifications held by the Seller for its products, the Seller has full authority in accordance with the applicable Law to authorize Us, including but not limited to the installation, placement, brand reproduction, name, and logo to be marketed and sold through Our Website and/or Application.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        f. Price of goods which was sold on Our Website is the price set by the Seller.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        g. Seller is fully responsible for all losses that might arise as a result of this negligence in meeting all legal obligations related to his activities as a Seller in Our Website.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        h. The Seller gives us the right and authority to freeze a part of or all of the payment which is supposed to be received by the Seller, in the event of fraud and/or violation of this User Terms as well as all other Agreements between the Seller and Us along with its/their attachments, as well as violations of fair and healthy trade transactions in accordance with applicable rules and regulations.
    </p>
    <h5 class="text-dark mx-5 px-5 text-justify font-weight-bold">
        4. Sales Transactions and Prices
    </h5>
    <p class="text-dark mx-5 px-5 text-justify">
        a. User who act as Buyers must transact through the transaction procedures that have been set by Us. Buyer make payments using the payment method previously chosen by the Buyer, and then We will continue payments to the Seller after the buy-sell transaction that the Buyer has made has been accomplished and received on Our system.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        b. By placing an order through Our Website and/or Application, the Buyer agrees to pay the total costs to be paid as stated in the payment page, which consists of the price of goods, taxes, shipping costs, and other costs that may arise and will be explicitly described in payment page.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        c. Buyer understand and agree that the availability of goods is the responsibility of the Seller who offers the goods. The availability of goods may change at any time, and if the goods is not available for sale, the Seller will reject the order and if the payment has been accomplished by the Buyer then We will return the money paid by the Buyer maximum within 10 (ten) Business Days.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        d. The Buyer fully understands and agrees that all payment transactions between the Buyer and the Seller were made through a payment gateway for cash payments or through company credit.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        e. Confirmation of payments made by the Buyer will be obtained by the Buyer through a Payment Gateway, as well as through relevant Financing Institution, so that the Buyer does not need to confirm the payment.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        f. Purchase confirmation will be given in the form of electronic order confirmation which can be downloaded by Buyer on Buyer’s Account on Our Website and/or Application.
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        g. After shipment is done and goods has been received properly and completely, other documents such as travel documents, invoices, and tax invoices from Seller are sent to the Buyer's email registered address or can be viewed and/or downloaded on the Account Transaction History (coming soon).
    </p>
    <p class="text-dark mx-5 px-5 text-justify">
        h. Buyer acknowledge and accept that purchases made and/or paid for on Saturdays, Sundays, National Holidays, and the last date of the month, may result in delayed issuance of documentation such as Invoice and Tax Invoice from the Seller. These documentations, if delayed, will issued on the next business day.
    </p>
    <h5 class="text-dark mx-5 px-5 text-justify font-weight-bold">
    ...
    <h5 class="text-dark mx-5 px-5 text-justify font-weight-bold">
        10. Closing and others
    </h5>
    <p class="text-dark mx-5 px-5 text-justify">
        This agreement will be regulated and agreed in accordance with the Regulations of the Republic of Indonesia.
    </p>
    <p class="text-dark mx-5 px-5 text-justify mb-3">
    ...
    <p class="text-dark mx-5 px-5 text-justify mb-5">
        In the case of conflict and/or disagreement by the User of this User Terms, the User must cease any activities on Our Website send Us an e-mail to delete the User’s account from Our Website.
    </p>
</div>
<!-- /.container-fluid -->
