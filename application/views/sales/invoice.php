                        ...
                        <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <?php foreach ($dataCart as $items) : ?>
                                    <?php
                                    if ($items['status'] != '3') { //show only with status = 1
                                        continue;
                                    } else {
                                        if ($before != $items['ref']) { ?>
                                            <td><?= $i ?></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= base_url('sales/createPDF/3/') . $items['ref'] . '/' . $items['name'] . '/' . $items['date'] ?>?>" class="badge badge-success">Preview Invoice</a>
                                            </td>
                                            </tr>
                                    <?php
                                            $before = $items['ref'];
