...
class Googlemaps
{
	...
	var $apiKey						= 'AIzaSyDnVQQuoRu9CoeIlM1To6xNSokg4zUBKvc'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	function GooglemapsConfig($config = array())
	{
		if (count($config) > 0) {
