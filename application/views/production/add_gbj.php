...
<div class="container-fluid">
    ...
    <a href="<?= base_url('production/gbj_report/index?' . http_build_query(['start_date' => $periode['start_date'], 'end_date'   => $periode['end_date'], 'name' => $periode['id'],])) ?>" class="btn btn-white btn-icon-split mb-3">
    ...
    <a href="<?= base_url('production/gbj_details/') . $po_id?>" class="btn btn-light border-success btn-icon-split mb-3" rel="noopener noreferrer">
                ...
                <div class="row">                       
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="report_date" name="report_date" value="<?= isset($last_material_date) ? $last_material_date : set_value('report_date'); ?>">
