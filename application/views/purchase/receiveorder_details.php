...
<div class="container-fluid">
    ...
    <a href="<?= base_url('purchasing/receiveorder/index?' . http_build_query(['start_date' => $periode['start_date'], 'end_date'   => $periode['end_date'], 'name' => $periode['id'],])) ?>" class="btn btn-white btn-icon-split mb-3">
        ...
        <div class="card-body mb-0">
            <div class="row">
                <div class="col-lg">
                    ...
                    <p id="product_name" class="text-dark font-weight-bold mb-3"> 
                        <?= $getID['description']; ?>
