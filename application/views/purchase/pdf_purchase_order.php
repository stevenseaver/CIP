...
$pdf->SetFont('', 'I', 8);
$pdf->Cell(277, 5, "1. Computerized documents are automatically validated.", 0, 1, 'L');
$pdf->Cell(277, 5, "2. Order quantity is as stated in this document.", 0, 1, 'L');
$pdf->Cell(277, 5, "3. Any discrepancy between order quantity and actual arrived goods must not exceed 10% and will be adjusted to the purchase invoice.", 0, 1, 'L');
$pdf->Cell(277, 5, "4. Any discrepancy beyond 10% will be returned to supplier.", 0, 1, 'L');
$pdf->Cell(277, 5, "5. Discrepancy between sample and actual goods must be inside our Incoming QC standards. Any goods that do not meet IQC standard will be returned.", 0, 1, 'L');
$pdf->Cell(277, 5, "6. Please contact our purchasing division +62 813 3133 525 for any inquiries.", 0, 1, 'L');
...
$pdf->Cell(277, 1, "", 0, 1, 'L');
$pdf->SetFont('', '', 8);
$pdf->Cell(277, 5, "1. PO ini dikeluarkan komputer, tidak perlu tanda tangan.", 0, 1, 'L');
$pdf->Cell(277, 5, "2. Produk kami digaransi selama 10-hari mencakup pengerjaan las dan jumlah barang.", 0, 1, 'L');
$pdf->Cell(277, 5, "3. Perbedaan jumlah kuantitas order dan barang yang datang tidak boleh melebihi 10% dan akan disesuaikan pada nota pembelian.", 0, 1, 'L');
$pdf->Cell(277, 5, "4. Perbedaan kuantitas lebih dari 10% akan dikembalikan kepada supplier.", 0, 1, 'L');
...
$pdf->Cell(277, 5, "6. Hubungi divisi pembelian kami di +62 813 3133 525 jika ada pertanyaan.", 0, 1, 'L');
