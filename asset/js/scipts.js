     ...
     //  JavaScript for add selected material item on GBJ wh production form
     ...
     //  JavaScript for add selected roll item on on GBJ wh production form
     ...
     //  JavaScript for add prepended data to Production add GBJ items
     ...
     //  JavaScript for add prepended data to Warehouse adjustment GBJ items
     $(".select-adj-gbj").click(function() {
         //extract data from data-* attributes of modal's add button
         var $row = $(this).closest("tr"); // Find the row
         var $name = $row.find(".name").text();
         var $code = $row.find(".code").text();
