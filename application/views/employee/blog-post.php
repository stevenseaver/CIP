...
<div class="container-fluid">
    ...
    <div class="card border-left-primary mb-4">
        <div class="card-body">
            <a href="<?= base_url("employee/blogpost"); ?>" class="btn btn-primary mb-3 text-white">Refresh</a>
                        ...
                        if ($user['role_id'] == 1) { ?>
                            <?php foreach ($blogdata as $bd) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a data-toggle="modal" data-target="#editAssetModal" class="badge badge-primary text-white clickable">Edit</a>
                                        <a data-toggle="modal" data-target="#deleteAssetModal" class="badge badge-danger clickable">Delete</a>
                                        <?php
                                        if ($user['role_id'] == '1') { ?>
...
<div class="modal fade" id="newPostModal" tabindex="-1" aria-labelledby="newPostModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?= base_url('employee/add_post') ?>" method="post">
