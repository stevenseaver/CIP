	...
	<div class="container-fluid pt-4 mt-5">
		...
		<div class="card border-primary bg-light text-grey mb-3">
			<img class="card-img my-2" src="<?= base_url('asset/') ?>img/undraw_posting_photo.svg" alt="Card image" width="200" height="400">
			<div class="card-img-overlay d-flex flex-column justify-content-center">
				<!-- d-flex atur flexible positioning, justify content center/end/top atur posisi object di dalam div ini -->
			...
			<div class="col-lg-4">
				<div class="card mb-4">
					<div class="card-body">
						...
						<a target="_blank" rel="nofollow" href="">Learn More &rarr;</a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4">
				<div class="card mb-4">
					<div class="card-body">
						...
						<p>We use more than 95% recycled plastic in our materials, creating demand for recycled plastic thus helping to reduce plastic waste in the landfill. </p>
						<!-- arahkan ke landing page soal high quality -->
						<a target="_blank" rel="nofollow" href="">Learn More &rarr;</a>
					</div>
				</div>
			...
			<div class="col-lg-4">
				<div class="card mb-4">
					<div class="card-body">
						...
						<!-- arahkan ke landing page soal high quality -->
						<a target="_blank" rel="nofollow" href="">Guideline &rarr;</a>
					</div>
				</div>
			</div>
